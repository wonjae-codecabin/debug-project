...
ActiveRecord::Schema[7.0].define(version: 2022_08_20_121100) do
  ...
  create_table "entries", force: :cascade do |t|
    ...
    t.string "corrective_action_msg"
    t.string "corrective_action_date"
    t.string "corrective_action_image"
